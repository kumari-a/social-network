...
<div id="insert_post" class="col-sm-12" style="background-color:#6b5b95;margin-top:40px; ">
	<center>
<form action="alumni.php?id=<?php echo $user_id; ?>" method="Post" enctype="multipart/form-data">
